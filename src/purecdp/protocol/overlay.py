# DO NOT EDIT — generated by purecdp._generator from Overlay (devtools-protocol 3bd8f01934b5)
'''CDP domain: Overlay.
...
class GridHighlightConfig:
    ...
    #: *(Optional)* Whether the extension lines from grid cells to the rulers should be shown (default: false).
    show_grid_extension_lines: bool | None = None
    #: *(Optional)* Show Positive line number labels (default: false).
    show_positive_line_numbers: bool | None = None
    #: *(Optional)* Show Negative line number labels (default: false).
    show_negative_line_numbers: bool | None = None
    #: *(Optional)* Show area name labels (default: false).
    show_area_names: bool | None = None
    #: *(Optional)* Show line name labels (default: false).
    show_line_names: bool | None = None
    #: *(Optional)* Show track size labels (default: false).
    show_track_sizes: bool | None = None
    #: *(Optional)* The grid container border highlight color (default: transparent).
    grid_border_color: dom.RGBA | None = None
    #: *(Optional)* The cell border color (default: transparent). Deprecated, please use rowLineColor and columnLineColor instead. *(DEPRECATED)*
    cell_border_color: dom.RGBA | None = None
    #: *(Optional)* The row line color (default: transparent).
    row_line_color: dom.RGBA | None = None
    #: *(Optional)* The column line color (default: transparent).
    column_line_color: dom.RGBA | None = None
    #: *(Optional)* Whether the grid border is dashed (default: false).
    grid_border_dash: bool | None = None
    #: *(Optional)* Whether the cell border is dashed (default: false). Deprecated, please us rowLineDash and columnLineDash instead. *(DEPRECATED)*
    cell_border_dash: bool | None = None
    #: *(Optional)* Whether row lines are dashed (default: false).
    row_line_dash: bool | None = None
    #: *(Optional)* Whether column lines are dashed (default: false).
    column_line_dash: bool | None = None
    #: *(Optional)* The row gap highlight fill color (default: transparent).
    row_gap_color: dom.RGBA | None = None
    #: *(Optional)* The row gap hatching fill color (default: transparent).
    row_hatch_color: dom.RGBA | None = None
    #: *(Optional)* The column gap highlight fill color (default: transparent).
    column_gap_color: dom.RGBA | None = None
    #: *(Optional)* The column gap hatching fill color (default: transparent).
    column_hatch_color: dom.RGBA | None = None
    #: *(Optional)* The named grid areas border color (Default: transparent).
    area_border_color: dom.RGBA | None = None
    #: *(Optional)* The grid container background color (Default: transparent).
    ...
    def from_json(cls, json: T_JSON_DICT) -> GridHighlightConfig:
        return cls(
            show_grid_extension_lines=json['showGridExtensionLines'] if json.get('showGridExtensionLines') is not None else None,
            show_positive_line_numbers=json['showPositiveLineNumbers'] if json.get('showPositiveLineNumbers') is not None else None,
            show_negative_line_numbers=json['showNegativeLineNumbers'] if json.get('showNegativeLineNumbers') is not None else None,
            show_area_names=json['showAreaNames'] if json.get('showAreaNames') is not None else None,
            show_line_names=json['showLineNames'] if json.get('showLineNames') is not None else None,
            show_track_sizes=json['showTrackSizes'] if json.get('showTrackSizes') is not None else None,
            grid_border_color=dom.RGBA.from_json(json['gridBorderColor']) if json.get('gridBorderColor') is not None else None,
            cell_border_color=dom.RGBA.from_json(json['cellBorderColor']) if json.get('cellBorderColor') is not None else None,
            row_line_color=dom.RGBA.from_json(json['rowLineColor']) if json.get('rowLineColor') is not None else None,
            column_line_color=dom.RGBA.from_json(json['columnLineColor']) if json.get('columnLineColor') is not None else None,
            grid_border_dash=json['gridBorderDash'] if json.get('gridBorderDash') is not None else None,
            cell_border_dash=json['cellBorderDash'] if json.get('cellBorderDash') is not None else None,
            row_line_dash=json['rowLineDash'] if json.get('rowLineDash') is not None else None,
            column_line_dash=json['columnLineDash'] if json.get('columnLineDash') is not None else None,
            row_gap_color=dom.RGBA.from_json(json['rowGapColor']) if json.get('rowGapColor') is not None else None,
            row_hatch_color=dom.RGBA.from_json(json['rowHatchColor']) if json.get('rowHatchColor') is not None else None,
            column_gap_color=dom.RGBA.from_json(json['columnGapColor']) if json.get('columnGapColor') is not None else None,
            column_hatch_color=dom.RGBA.from_json(json['columnHatchColor']) if json.get('columnHatchColor') is not None else None,
            area_border_color=dom.RGBA.from_json(json['areaBorderColor']) if json.get('areaBorderColor') is not None else None,
            grid_background_color=dom.RGBA.from_json(json['gridBackgroundColor']) if json.get('gridBackgroundColor') is not None else None,
        )
...
class FlexContainerHighlightConfig:
    ...
    #: *(Optional)* The style of the container border
    container_border: LineStyle | None = None
    #: *(Optional)* The style of the separator between lines
    line_separator: LineStyle | None = None
    #: *(Optional)* The style of the separator between items
    item_separator: LineStyle | None = None
    #: *(Optional)* Style of content-distribution space on the main axis (justify-content).
    main_distributed_space: BoxStyle | None = None
    #: *(Optional)* Style of content-distribution space on the cross axis (align-content).
    cross_distributed_space: BoxStyle | None = None
    #: *(Optional)* Style of empty space caused by row gaps (gap/row-gap).
    row_gap_space: BoxStyle | None = None
    #: *(Optional)* Style of empty space caused by columns gaps (gap/column-gap).
    column_gap_space: BoxStyle | None = None
    #: *(Optional)* Style of the self-alignment line (align-items).
    ...
    def from_json(cls, json: T_JSON_DICT) -> FlexContainerHighlightConfig:
        return cls(
            container_border=LineStyle.from_json(json['containerBorder']) if json.get('containerBorder') is not None else None,
            line_separator=LineStyle.from_json(json['lineSeparator']) if json.get('lineSeparator') is not None else None,
            item_separator=LineStyle.from_json(json['itemSeparator']) if json.get('itemSeparator') is not None else None,
            main_distributed_space=BoxStyle.from_json(json['mainDistributedSpace']) if json.get('mainDistributedSpace') is not None else None,
            cross_distributed_space=BoxStyle.from_json(json['crossDistributedSpace']) if json.get('crossDistributedSpace') is not None else None,
            row_gap_space=BoxStyle.from_json(json['rowGapSpace']) if json.get('rowGapSpace') is not None else None,
            column_gap_space=BoxStyle.from_json(json['columnGapSpace']) if json.get('columnGapSpace') is not None else None,
            cross_alignment=LineStyle.from_json(json['crossAlignment']) if json.get('crossAlignment') is not None else None,
        )
...
class FlexItemHighlightConfig:
    ...
    #: *(Optional)* Style of the box representing the item's base size
    base_size_box: BoxStyle | None = None
    #: *(Optional)* Style of the border around the box representing the item's base size
    base_size_border: LineStyle | None = None
    #: *(Optional)* Style of the arrow representing if the item grew or shrank
    ...
    def from_json(cls, json: T_JSON_DICT) -> FlexItemHighlightConfig:
        return cls(
            base_size_box=BoxStyle.from_json(json['baseSizeBox']) if json.get('baseSizeBox') is not None else None,
            base_size_border=LineStyle.from_json(json['baseSizeBorder']) if json.get('baseSizeBorder') is not None else None,
            flexibility_arrow=LineStyle.from_json(json['flexibilityArrow']) if json.get('flexibilityArrow') is not None else None,
        )
...
class LineStyle:
    ...
    #: *(Optional)* The color of the line (default: transparent)
    color: dom.RGBA | None = None
    #: *(Optional)* The line pattern (default: solid) Allowed values: dashed, dotted
    ...
    def from_json(cls, json: T_JSON_DICT) -> LineStyle:
        return cls(
            color=dom.RGBA.from_json(json['color']) if json.get('color') is not None else None,
            pattern=json['pattern'] if json.get('pattern') is not None else None,
        )
...
class BoxStyle:
    ...
    #: *(Optional)* The background color for the box (default: transparent)
    fill_color: dom.RGBA | None = None
    #: *(Optional)* The hatching color for the box (default: transparent)
    ...
    def from_json(cls, json: T_JSON_DICT) -> BoxStyle:
        return cls(
            fill_color=dom.RGBA.from_json(json['fillColor']) if json.get('fillColor') is not None else None,
            hatch_color=dom.RGBA.from_json(json['hatchColor']) if json.get('hatchColor') is not None else None,
        )


class ContrastAlgorithm(enum.StrEnum):
    AA = 'aa'
    AAA = 'aaa'
    APCA = 'apca'
...
class HighlightConfig:
    ...
    #: *(Optional)* Whether the a11y info should be shown (default: true).
    ...
    #: *(Optional)* The color format used to format color styles (default: hex).
    color_format: ColorFormat | None = None
    #: *(Optional)* The grid layout highlight configuration (default: all transparent).
    grid_highlight_config: GridHighlightConfig | None = None
    #: *(Optional)* The flex container highlight configuration (default: all transparent).
    flex_container_highlight_config: FlexContainerHighlightConfig | None = None
    #: *(Optional)* The flex item highlight configuration (default: all transparent).
    flex_item_highlight_config: FlexItemHighlightConfig | None = None
    #: *(Optional)* The contrast algorithm to use for the contrast ratio (default: aa).
    contrast_algorithm: ContrastAlgorithm | None = None
    #: *(Optional)* The container query container highlight configuration (default: all transparent).
    ...
    def from_json(cls, json: T_JSON_DICT) -> HighlightConfig:
        return cls(
            show_info=json['showInfo'] if json.get('showInfo') is not None else None,
            show_styles=json['showStyles'] if json.get('showStyles') is not None else None,
            show_rulers=json['showRulers'] if json.get('showRulers') is not None else None,
            show_accessibility_info=json['showAccessibilityInfo'] if json.get('showAccessibilityInfo') is not None else None,
            show_extension_lines=json['showExtensionLines'] if json.get('showExtensionLines') is not None else None,
            content_color=dom.RGBA.from_json(json['contentColor']) if json.get('contentColor') is not None else None,
            padding_color=dom.RGBA.from_json(json['paddingColor']) if json.get('paddingColor') is not None else None,
            border_color=dom.RGBA.from_json(json['borderColor']) if json.get('borderColor') is not None else None,
            margin_color=dom.RGBA.from_json(json['marginColor']) if json.get('marginColor') is not None else None,
            event_target_color=dom.RGBA.from_json(json['eventTargetColor']) if json.get('eventTargetColor') is not None else None,
            shape_color=dom.RGBA.from_json(json['shapeColor']) if json.get('shapeColor') is not None else None,
            shape_margin_color=dom.RGBA.from_json(json['shapeMarginColor']) if json.get('shapeMarginColor') is not None else None,
            css_grid_color=dom.RGBA.from_json(json['cssGridColor']) if json.get('cssGridColor') is not None else None,
            color_format=ColorFormat.from_json(json['colorFormat']) if json.get('colorFormat') is not None else None,
            grid_highlight_config=GridHighlightConfig.from_json(json['gridHighlightConfig']) if json.get('gridHighlightConfig') is not None else None,
            flex_container_highlight_config=FlexContainerHighlightConfig.from_json(json['flexContainerHighlightConfig']) if json.get('flexContainerHighlightConfig') is not None else None,
            flex_item_highlight_config=FlexItemHighlightConfig.from_json(json['flexItemHighlightConfig']) if json.get('flexItemHighlightConfig') is not None else None,
            contrast_algorithm=ContrastAlgorithm.from_json(json['contrastAlgorithm']) if json.get('contrastAlgorithm') is not None else None,
            container_query_container_highlight_config=ContainerQueryContainerHighlightConfig.from_json(json['containerQueryContainerHighlightConfig']) if json.get('containerQueryContainerHighlightConfig') is not None else None,
        )
...
class ScrollSnapContainerHighlightConfig:
    #: *(Optional)* The style of the snapport border (default: transparent)
    snapport_border: LineStyle | None = None
    #: *(Optional)* The style of the snap area border (default: transparent)
    ...
    def from_json(cls, json: T_JSON_DICT) -> ScrollSnapContainerHighlightConfig:
        return cls(
            snapport_border=LineStyle.from_json(json['snapportBorder']) if json.get('snapportBorder') is not None else None,
            snap_area_border=LineStyle.from_json(json['snapAreaBorder']) if json.get('snapAreaBorder') is not None else None,
            scroll_margin_color=dom.RGBA.from_json(json['scrollMarginColor']) if json.get('scrollMarginColor') is not None else None,
            scroll_padding_color=dom.RGBA.from_json(json['scrollPaddingColor']) if json.get('scrollPaddingColor') is not None else None,
        )
...
class HingeConfig:
    ...
    rect: dom.Rect
    #: *(Optional)* The content box highlight fill color (default: a dark color).
    content_color: dom.RGBA | None = None
    ...
    def from_json(cls, json: T_JSON_DICT) -> HingeConfig:
        return cls(
            ...
            content_color=dom.RGBA.from_json(json['contentColor']) if json.get('contentColor') is not None else None,
            outline_color=dom.RGBA.from_json(json['outlineColor']) if json.get('outlineColor') is not None else None,
        )


class DisplayCutoutShape(enum.StrEnum):
...
class DisplayCutoutConfig:
    ...
    #: *(Optional)* Border radius for rounded cutout shapes.
    border_radius: int | None = None
    #: *(Optional)* Upper shoulder radius for notch cutout shapes.
    upper_radius: int | None = None
    #: *(Optional)* Lower transition radius for notch cutout shapes.
    lower_radius: int | None = None
    #: *(Optional)* Center x coordinate for circle cutout shapes.
    cx: int | None = None
    #: *(Optional)* Center y coordinate for circle cutout shapes.
    cy: int | None = None
    #: *(Optional)* Radius for circle cutout shapes.
    radius: int | None = None
    #: *(Optional)* The cutout fill color (default: black).
    content_color: dom.RGBA | None = None
    ...
    def from_json(cls, json: T_JSON_DICT) -> DisplayCutoutConfig:
        return cls(
            ...
            border_radius=json['borderRadius'] if json.get('borderRadius') is not None else None,
            upper_radius=json['upperRadius'] if json.get('upperRadius') is not None else None,
            lower_radius=json['lowerRadius'] if json.get('lowerRadius') is not None else None,
            cx=json['cx'] if json.get('cx') is not None else None,
            cy=json['cy'] if json.get('cy') is not None else None,
            radius=json['radius'] if json.get('radius') is not None else None,
            content_color=dom.RGBA.from_json(json['contentColor']) if json.get('contentColor') is not None else None,
        )
...
class WindowControlsOverlayConfig:
    ...
    def from_json(cls, json: T_JSON_DICT) -> WindowControlsOverlayConfig:
        return cls(
            show_css=json['showCSS'],
            selected_platform=json['selectedPlatform'],
...
class ContainerQueryContainerHighlightConfig:
    #: *(Optional)* The style of the container border.
    container_border: LineStyle | None = None
    #: *(Optional)* The style of the descendants' borders.
    ...
    def from_json(cls, json: T_JSON_DICT) -> ContainerQueryContainerHighlightConfig:
        return cls(
            container_border=LineStyle.from_json(json['containerBorder']) if json.get('containerBorder') is not None else None,
            descendant_border=LineStyle.from_json(json['descendantBorder']) if json.get('descendantBorder') is not None else None,
        )
...
class IsolationModeHighlightConfig:
    #: *(Optional)* The fill color of the resizers (default: transparent).
    resizer_color: dom.RGBA | None = None
    #: *(Optional)* The fill color for resizer handles (default: transparent).
    resizer_handle_color: dom.RGBA | None = None
    #: *(Optional)* The fill color for the mask covering non-isolated elements (default: transparent).
    ...
    def from_json(cls, json: T_JSON_DICT) -> IsolationModeHighlightConfig:
        return cls(
            resizer_color=dom.RGBA.from_json(json['resizerColor']) if json.get('resizerColor') is not None else None,
            resizer_handle_color=dom.RGBA.from_json(json['resizerHandleColor']) if json.get('resizerHandleColor') is not None else None,
            mask_color=dom.RGBA.from_json(json['maskColor']) if json.get('maskColor') is not None else None,
        )


class InspectMode(enum.StrEnum):
    SEARCH_FOR_NODE = 'searchForNode'
    SEARCH_FOR_UASHADOW_DOM = 'searchForUAShadowDOM'
...
class InspectedElementAnchorConfig:
    ...
    def from_json(cls, json: T_JSON_DICT) -> InspectedElementAnchorConfig:
        return cls(
            node_id=dom.NodeId.from_json(json['nodeId']) if json.get('nodeId') is not None else None,
...
def disable() -> typing.Generator[T_JSON_DICT, T_JSON_DICT, None]:
    ...
    yield {'method': 'Overlay.disable'}


def enable() -> typing.Generator[T_JSON_DICT, T_JSON_DICT, None]:
    '''Enables domain notifications.'''
    yield {'method': 'Overlay.enable'}
...
def get_highlight_object_for_test(
    ...
    json = yield {'method': 'Overlay.getHighlightObjectForTest', 'params': params}
...
def get_grid_highlight_objects_for_test(
    ...
    json = yield {'method': 'Overlay.getGridHighlightObjectsForTest', 'params': params}
...
def get_source_order_highlight_object_for_test(
    ...
    params: T_JSON_DICT = {}
    params['nodeId'] = node_id.to_json()
    json = yield {'method': 'Overlay.getSourceOrderHighlightObjectForTest', 'params': params}
    return json['highlight']


def hide_highlight() -> typing.Generator[T_JSON_DICT, T_JSON_DICT, None]:
    '''Hides any highlight.'''
    yield {'method': 'Overlay.hideHighlight'}
...
def highlight_frame(
    ...
    **DEPRECATED**
    ...
    yield {'method': 'Overlay.highlightFrame', 'params': params}
...
def highlight_node(
    ...
    yield {'method': 'Overlay.highlightNode', 'params': params}
...
def highlight_quad(
    ...
    yield {'method': 'Overlay.highlightQuad', 'params': params}
...
def highlight_rect(
    ...
    if outline_color is not None:
        params['outlineColor'] = outline_color.to_json()
    yield {'method': 'Overlay.highlightRect', 'params': params}
...
def highlight_source_order(
    ...
    if object_id is not None:
        params['objectId'] = object_id.to_json()
    yield {'method': 'Overlay.highlightSourceOrder', 'params': params}
...
def set_inspect_mode(
    ...
    if highlight_config is not None:
        params['highlightConfig'] = highlight_config.to_json()
    yield {'method': 'Overlay.setInspectMode', 'params': params}
...
def set_show_ad_highlights(show: bool) -> typing.Generator[T_JSON_DICT, T_JSON_DICT, None]:
    ...
    params: T_JSON_DICT = {}
    params['show'] = show
    yield {'method': 'Overlay.setShowAdHighlights', 'params': params}
...
def set_paused_in_debugger_message(
    ...
    yield {'method': 'Overlay.setPausedInDebuggerMessage', 'params': params}
...
def set_show_debug_borders(show: bool) -> typing.Generator[T_JSON_DICT, T_JSON_DICT, None]:
    ...
    params: T_JSON_DICT = {}
    params['show'] = show
    yield {'method': 'Overlay.setShowDebugBorders', 'params': params}
...
def set_show_fps_counter(show: bool) -> typing.Generator[T_JSON_DICT, T_JSON_DICT, None]:
    ...
    params: T_JSON_DICT = {}
    params['show'] = show
    yield {'method': 'Overlay.setShowFPSCounter', 'params': params}
...
def set_show_grid_overlays(
    ...
    yield {'method': 'Overlay.setShowGridOverlays', 'params': params}
...
def set_show_flex_overlays(
    ...
    yield {'method': 'Overlay.setShowFlexOverlays', 'params': params}
...
def set_show_scroll_snap_overlays(
    ...
    yield {'method': 'Overlay.setShowScrollSnapOverlays', 'params': params}
...
def set_show_container_query_overlays(
    ...
    yield {'method': 'Overlay.setShowContainerQueryOverlays', 'params': params}
...
def set_show_inspected_element_anchor(
    ...
    yield {'method': 'Overlay.setShowInspectedElementAnchor', 'params': params}
...
def set_show_paint_rects(result: bool) -> typing.Generator[T_JSON_DICT, T_JSON_DICT, None]:
    ...
    yield {'method': 'Overlay.setShowPaintRects', 'params': params}
...
def set_show_layout_shift_regions(result: bool) -> typing.Generator[T_JSON_DICT, T_JSON_DICT, None]:
    ...
    params: T_JSON_DICT = {}
    params['result'] = result
    yield {'method': 'Overlay.setShowLayoutShiftRegions', 'params': params}
...
def set_show_scroll_bottleneck_rects(
    ...
    params: T_JSON_DICT = {}
    params['show'] = show
    yield {'method': 'Overlay.setShowScrollBottleneckRects', 'params': params}
...
def set_show_hit_test_borders(show: bool) -> typing.Generator[T_JSON_DICT, T_JSON_DICT, None]:
    ...
    **DEPRECATED**
    ...
    params: T_JSON_DICT = {}
    params['show'] = show
    yield {'method': 'Overlay.setShowHitTestBorders', 'params': params}
...
def set_show_web_vitals(show: bool) -> typing.Generator[T_JSON_DICT, T_JSON_DICT, None]:
    ...
    **DEPRECATED**
    ...
    params: T_JSON_DICT = {}
    params['show'] = show
    yield {'method': 'Overlay.setShowWebVitals', 'params': params}
...
def set_show_viewport_size_on_resize(
    ...
    params: T_JSON_DICT = {}
    params['show'] = show
    yield {'method': 'Overlay.setShowViewportSizeOnResize', 'params': params}
...
def set_show_hinge(
    ...
    yield {'method': 'Overlay.setShowHinge', 'params': params}
...
def set_show_display_cutout(
    ...
    yield {'method': 'Overlay.setShowDisplayCutout', 'params': params}
...
def set_show_isolated_elements(
    ...
    yield {'method': 'Overlay.setShowIsolatedElements', 'params': params}
...
def set_show_window_controls_overlay(
    ...
    yield {'method': 'Overlay.setShowWindowControlsOverlay', 'params': params}
