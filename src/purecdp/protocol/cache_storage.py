# DO NOT EDIT — generated by purecdp._generator from CacheStorage (devtools-protocol 3bd8f01934b5)
'''CDP domain: CacheStorage.
...
class CacheId(str):
    ...
    def __repr__(self) -> str:
        return f'CacheId({str.__repr__(self)})'


class CachedResponseType(enum.StrEnum):
...
class Cache:
    ...
    cache_name: str
    #: *(Optional)* Storage bucket of the cache.
    ...
    def from_json(cls, json: T_JSON_DICT) -> Cache:
        return cls(
            ...
            storage_bucket=storage.StorageBucket.from_json(json['storageBucket']) if json.get('storageBucket') is not None else None,
        )
...
def delete_cache(cache_id: CacheId) -> typing.Generator[T_JSON_DICT, T_JSON_DICT, None]:
    ...
    yield {'method': 'CacheStorage.deleteCache', 'params': params}
...
def delete_entry(
    ...
    yield {'method': 'CacheStorage.deleteEntry', 'params': params}
...
def request_cache_names(
    ...
    json = yield {'method': 'CacheStorage.requestCacheNames', 'params': params}
...
def request_cached_response(
    ...
    json = yield {'method': 'CacheStorage.requestCachedResponse', 'params': params}
...
def request_entries(
    ...
    json = yield {'method': 'CacheStorage.requestEntries', 'params': params}
    return (
