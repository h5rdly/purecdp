# DO NOT EDIT — generated by purecdp._generator from HeapProfiler (devtools-protocol 3bd8f01934b5)
'''CDP domain: HeapProfiler.
...
class HeapSnapshotObjectId(str):
    ...
    def __repr__(self) -> str:
        return f'HeapSnapshotObjectId({str.__repr__(self)})'
...
def add_inspected_heap_object(
    ...
    yield {'method': 'HeapProfiler.addInspectedHeapObject', 'params': params}


def collect_garbage() -> typing.Generator[T_JSON_DICT, T_JSON_DICT, None]:
    yield {'method': 'HeapProfiler.collectGarbage'}


def disable() -> typing.Generator[T_JSON_DICT, T_JSON_DICT, None]:
    yield {'method': 'HeapProfiler.disable'}


def enable() -> typing.Generator[T_JSON_DICT, T_JSON_DICT, None]:
    yield {'method': 'HeapProfiler.enable'}
...
def get_heap_object_id(
    ...
    json = yield {'method': 'HeapProfiler.getHeapObjectId', 'params': params}
...
def get_object_by_heap_object_id(
    ...
    json = yield {'method': 'HeapProfiler.getObjectByHeapObjectId', 'params': params}
...
def get_sampling_profile() -> typing.Generator[T_JSON_DICT, T_JSON_DICT, SamplingHeapProfile]:
    ...
    json = yield {'method': 'HeapProfiler.getSamplingProfile'}
...
def start_sampling(
    ...
    yield {'method': 'HeapProfiler.startSampling', 'params': params}
...
def stop_tracking_heap_objects(
    ...
    :param treat_global_objects_as_roots: *(Optional)* Deprecated in favor of `exposeInternals`. *(DEPRECATED)*
    :param capture_numeric_value: *(Optional)* If true, numerical values are included in the snapshot
    :param expose_internals: *(Optional)* If true, exposes internals of the snapshot. *(EXPERIMENTAL)*
    '''
    params: T_JSON_DICT = {}
    ...
    yield {'method': 'HeapProfiler.stopTrackingHeapObjects', 'params': params}
...
def take_heap_snapshot(
    ...
    :param treat_global_objects_as_roots: *(Optional)* If true, a raw snapshot without artificial roots will be generated. Deprecated in favor of `exposeInternals`. *(DEPRECATED)*
    :param capture_numeric_value: *(Optional)* If true, numerical values are included in the snapshot
    :param expose_internals: *(Optional)* If true, exposes internals of the snapshot. *(EXPERIMENTAL)*
    '''
    params: T_JSON_DICT = {}
    ...
    if expose_internals is not None:
        params['exposeInternals'] = expose_internals
    yield {'method': 'HeapProfiler.takeHeapSnapshot', 'params': params}
...
class HeapStatsUpdate:
    ...
    def from_json(cls, json: T_JSON_DICT) -> HeapStatsUpdate:
        return cls(
            stats_update=list(json['statsUpdate']),
        )
...
class LastSeenObjectId:
    ...
    def from_json(cls, json: T_JSON_DICT) -> LastSeenObjectId:
        return cls(
            last_seen_object_id=json['lastSeenObjectId'],
...
class ReportHeapSnapshotProgress:
    ...
    def from_json(cls, json: T_JSON_DICT) -> ReportHeapSnapshotProgress:
        return cls(
            ...
            total=json['total'],
            finished=json['finished'] if json.get('finished') is not None else None,
        )
