# DO NOT EDIT — generated by purecdp._generator from PerformanceTimeline (devtools-protocol 3bd8f01934b5)
'''CDP domain: PerformanceTimeline.
...
class LargestContentfulPaint:
    ...
    size: float
    #: *(Optional)* The id attribute of the element, if available.
    element_id: str | None = None
    #: *(Optional)* The URL of the image (may be trimmed).
    url: str | None = None
    #: *(Optional)*
    ...
    def from_json(cls, json: T_JSON_DICT) -> LargestContentfulPaint:
        return cls(
            ...
            element_id=json['elementId'] if json.get('elementId') is not None else None,
...
class LayoutShift:
    ...
    def from_json(cls, json: T_JSON_DICT) -> LayoutShift:
        return cls(
            ...
            had_recent_input=json['hadRecentInput'],
...
class TimelineEvent:
    ...
    #: *(Optional)* Event duration, if applicable.
    ...
    def from_json(cls, json: T_JSON_DICT) -> TimelineEvent:
        return cls(
            ...
            duration=float(json['duration']) if json.get('duration') is not None else None,
            lcp_details=LargestContentfulPaint.from_json(json['lcpDetails']) if json.get('lcpDetails') is not None else None,
            layout_shift_details=LayoutShift.from_json(json['layoutShiftDetails']) if json.get('layoutShiftDetails') is not None else None,
        )
...
def enable(event_types: list[str]) -> typing.Generator[T_JSON_DICT, T_JSON_DICT, None]:
    ...
    '''
    params: T_JSON_DICT = {}
    params['eventTypes'] = list(event_types)
    yield {'method': 'PerformanceTimeline.enable', 'params': params}
