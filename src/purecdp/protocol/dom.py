# DO NOT EDIT — generated by purecdp._generator from DOM (devtools-protocol 3bd8f01934b5)
'''CDP domain: DOM.
...
class NodeId(int):
    ...
    def __repr__(self) -> str:
        return f'NodeId({int.__repr__(self)})'
...
class BackendNodeId(int):
    ...
    def __repr__(self) -> str:
        return f'BackendNodeId({int.__repr__(self)})'
...
class StyleSheetId(str):
    ...
    def __repr__(self) -> str:
        return f'StyleSheetId({str.__repr__(self)})'
...
class ShadowRootType(enum.StrEnum):
    '''Shadow root type.'''
...
class CompatibilityMode(enum.StrEnum):
...
class PhysicalAxes(enum.StrEnum):
...
class LogicalAxes(enum.StrEnum):
...
class ScrollOrientation(enum.StrEnum):
...
class Node:
    ...
    #: *(Optional)* Deprecated, as the HTML Imports API has been removed (crbug.com/937746). This property used to return the imported document for the HTMLImport links. The property is always undefined now. *(DEPRECATED)*
    ...
    def from_json(cls, json: T_JSON_DICT) -> Node:
        return cls(
            ...
            parent_id=NodeId.from_json(json['parentId']) if json.get('parentId') is not None else None,
            child_node_count=json['childNodeCount'] if json.get('childNodeCount') is not None else None,
            children=[Node.from_json(i) for i in json['children']] if json.get('children') is not None else None,
            attributes=list(json['attributes']) if json.get('attributes') is not None else None,
            ...
            internal_subset=json['internalSubset'] if json.get('internalSubset') is not None else None,
            xml_version=json['xmlVersion'] if json.get('xmlVersion') is not None else None,
            name=json['name'] if json.get('name') is not None else None,
            value=json['value'] if json.get('value') is not None else None,
            pseudo_type=PseudoType.from_json(json['pseudoType']) if json.get('pseudoType') is not None else None,
            pseudo_identifier=json['pseudoIdentifier'] if json.get('pseudoIdentifier') is not None else None,
            shadow_root_type=ShadowRootType.from_json(json['shadowRootType']) if json.get('shadowRootType') is not None else None,
            frame_id=page.FrameId.from_json(json['frameId']) if json.get('frameId') is not None else None,
            content_document=Node.from_json(json['contentDocument']) if json.get('contentDocument') is not None else None,
            shadow_roots=[Node.from_json(i) for i in json['shadowRoots']] if json.get('shadowRoots') is not None else None,
            template_content=Node.from_json(json['templateContent']) if json.get('templateContent') is not None else None,
            pseudo_elements=[Node.from_json(i) for i in json['pseudoElements']] if json.get('pseudoElements') is not None else None,
            imported_document=Node.from_json(json['importedDocument']) if json.get('importedDocument') is not None else None,
            distributed_nodes=[BackendNode.from_json(i) for i in json['distributedNodes']] if json.get('distributedNodes') is not None else None,
            is_svg=json['isSVG'] if json.get('isSVG') is not None else None,
            compatibility_mode=CompatibilityMode.from_json(json['compatibilityMode']) if json.get('compatibilityMode') is not None else None,
            assigned_slot=BackendNode.from_json(json['assignedSlot']) if json.get('assignedSlot') is not None else None,
            is_scrollable=json['isScrollable'] if json.get('isScrollable') is not None else None,
            affected_by_starting_styles=json['affectedByStartingStyles'] if json.get('affectedByStartingStyles') is not None else None,
            adopted_style_sheets=[StyleSheetId.from_json(i) for i in json['adoptedStyleSheets']] if json.get('adoptedStyleSheets') is not None else None,
            ad_provenance=network.AdProvenance.from_json(json['adProvenance']) if json.get('adProvenance') is not None else None,
        )
...
class RGBA:
    ...
    def from_json(cls, json: T_JSON_DICT) -> RGBA:
        return cls(
            ...
            g=json['g'],
            b=json['b'],
            a=float(json['a']) if json.get('a') is not None else None,
        )
...
class Quad(list):
    ...
    @classmethod
    def from_json(cls, json: list) -> Quad:
        return cls([float(i) for i in json])

    def __repr__(self) -> str:
        return f'Quad({list.__repr__(self)})'
...
class BoxModel:
    ...
    def from_json(cls, json: T_JSON_DICT) -> BoxModel:
        return cls(
            ...
            width=json['width'],
            height=json['height'],
            shape_outside=ShapeOutsideInfo.from_json(json['shapeOutside']) if json.get('shapeOutside') is not None else None,
        )
...
def collect_class_names_from_subtree(
    ...
    **EXPERIMENTAL**
    ...
    json = yield {'method': 'DOM.collectClassNamesFromSubtree', 'params': params}
...
def copy_to(
    ...
    **EXPERIMENTAL**
    ...
    json = yield {'method': 'DOM.copyTo', 'params': params}
...
def describe_node(
    ...
    json = yield {'method': 'DOM.describeNode', 'params': params}
...
def scroll_into_view_if_needed(
    ...
    yield {'method': 'DOM.scrollIntoViewIfNeeded', 'params': params}


def disable() -> typing.Generator[T_JSON_DICT, T_JSON_DICT, None]:
    '''Disables DOM agent for the given page.'''
    yield {'method': 'DOM.disable'}
...
def discard_search_results(search_id: str) -> typing.Generator[T_JSON_DICT, T_JSON_DICT, None]:
    ...
    **EXPERIMENTAL**
    ...
    yield {'method': 'DOM.discardSearchResults', 'params': params}
...
def enable(
    ...
    :param include_whitespace: *(Optional)* Whether to include whitespaces in the children array of returned Nodes. Allowed values: none, all *(EXPERIMENTAL)*
    '''
    params: T_JSON_DICT = {}
    if include_whitespace is not None:
        params['includeWhitespace'] = include_whitespace
    yield {'method': 'DOM.enable', 'params': params}
...
def focus(
    ...
    if object_id is not None:
        params['objectId'] = object_id.to_json()
    yield {'method': 'DOM.focus', 'params': params}
...
def get_attributes(node_id: NodeId) -> typing.Generator[T_JSON_DICT, T_JSON_DICT, list[str]]:
    ...
    params: T_JSON_DICT = {}
    params['nodeId'] = node_id.to_json()
    json = yield {'method': 'DOM.getAttributes', 'params': params}
    return list(json['attributes'])
...
def get_box_model(
    ...
    if object_id is not None:
        params['objectId'] = object_id.to_json()
    json = yield {'method': 'DOM.getBoxModel', 'params': params}
...
def get_content_quads(
    ...
    **EXPERIMENTAL**
    ...
    if object_id is not None:
        params['objectId'] = object_id.to_json()
    json = yield {'method': 'DOM.getContentQuads', 'params': params}
...
def get_document(
    ...
    if pierce is not None:
        params['pierce'] = pierce
    json = yield {'method': 'DOM.getDocument', 'params': params}
...
def get_flattened_document(
    ...
    **DEPRECATED**
    ...
    if pierce is not None:
        params['pierce'] = pierce
    json = yield {'method': 'DOM.getFlattenedDocument', 'params': params}
...
def get_nodes_for_subtree_by_style(
    ...
    **EXPERIMENTAL**
    ...
    if pierce is not None:
        params['pierce'] = pierce
    json = yield {'method': 'DOM.getNodesForSubtreeByStyle', 'params': params}
...
def get_node_for_location(
...
) -> typing.Generator[T_JSON_DICT, T_JSON_DICT, tuple[BackendNodeId, page.FrameId, NodeId | None]]:
    ...
    json = yield {'method': 'DOM.getNodeForLocation', 'params': params}
    return (
        BackendNodeId.from_json(json['backendNodeId']),
        page.FrameId.from_json(json['frameId']),
        NodeId.from_json(json['nodeId']) if json.get('nodeId') is not None else None,
    )
...
def get_outer_html(
    ...
    :param backend_node_id: *(Optional)* Identifier of the backend node.
    :param object_id: *(Optional)* JavaScript object id of the node wrapper.
    :param include_shadow_dom: *(Optional)* Include all shadow roots. Equals to false if not specified. *(EXPERIMENTAL)*
    ...
    json = yield {'method': 'DOM.getOuterHTML', 'params': params}
    return json['outerHTML']
...
def get_relayout_boundary(node_id: NodeId) -> typing.Generator[T_JSON_DICT, T_JSON_DICT, NodeId]:
    ...
    **EXPERIMENTAL**
    ...
    params: T_JSON_DICT = {}
    params['nodeId'] = node_id.to_json()
    json = yield {'method': 'DOM.getRelayoutBoundary', 'params': params}
    return NodeId.from_json(json['nodeId'])
...
def mark_undoable_state() -> typing.Generator[T_JSON_DICT, T_JSON_DICT, None]:
    ...
    **EXPERIMENTAL**
    '''
    yield {'method': 'DOM.markUndoableState'}
...
def move_to(
    ...
    if insert_before_node_id is not None:
        params['insertBeforeNodeId'] = insert_before_node_id.to_json()
    json = yield {'method': 'DOM.moveTo', 'params': params}
    return NodeId.from_json(json['nodeId'])
...
def perform_search(
    ...
    **EXPERIMENTAL**
    ...
    if include_user_agent_shadow_dom is not None:
        params['includeUserAgentShadowDOM'] = include_user_agent_shadow_dom
    json = yield {'method': 'DOM.performSearch', 'params': params}
    return (
        json['searchId'],
        json['resultCount'],
    )
...
def push_node_by_path_to_frontend(path: str) -> typing.Generator[T_JSON_DICT, T_JSON_DICT, NodeId]:
    ...
    **EXPERIMENTAL**
    ...
    params: T_JSON_DICT = {}
    params['path'] = path
    json = yield {'method': 'DOM.pushNodeByPathToFrontend', 'params': params}
    return NodeId.from_json(json['nodeId'])
...
def push_nodes_by_backend_ids_to_frontend(
    ...
    **EXPERIMENTAL**
    ...
    json = yield {'method': 'DOM.pushNodesByBackendIdsToFrontend', 'params': params}
    return [NodeId.from_json(i) for i in json['nodeIds']]
...
def query_selector(
    ...
    json = yield {'method': 'DOM.querySelector', 'params': params}
    return NodeId.from_json(json['nodeId'])
...
def query_selector_all(
    ...
    params['nodeId'] = node_id.to_json()
    params['selector'] = selector
    json = yield {'method': 'DOM.querySelectorAll', 'params': params}
    return [NodeId.from_json(i) for i in json['nodeIds']]
...
def get_top_layer_elements() -> typing.Generator[T_JSON_DICT, T_JSON_DICT, list[NodeId]]:
    ...
    **EXPERIMENTAL**
    ...
    '''
    json = yield {'method': 'DOM.getTopLayerElements'}
    return [NodeId.from_json(i) for i in json['nodeIds']]
...
def get_element_by_relation(
    ...
    **EXPERIMENTAL**
    ...
    :param relation: Type of relation to get. Allowed values: PopoverTarget, InterestTarget, CommandFor
    :returns: NodeId of the element matching the queried relation.
    '''
    params: T_JSON_DICT = {}
    params['nodeId'] = node_id.to_json()
    params['relation'] = relation
    json = yield {'method': 'DOM.getElementByRelation', 'params': params}
    return NodeId.from_json(json['nodeId'])
...
def remove_attribute(
    ...
    params['nodeId'] = node_id.to_json()
    params['name'] = name
    yield {'method': 'DOM.removeAttribute', 'params': params}
...
def remove_node(node_id: NodeId) -> typing.Generator[T_JSON_DICT, T_JSON_DICT, None]:
    ...
    params: T_JSON_DICT = {}
    params['nodeId'] = node_id.to_json()
    yield {'method': 'DOM.removeNode', 'params': params}
...
def request_child_nodes(
    ...
    if pierce is not None:
        params['pierce'] = pierce
    yield {'method': 'DOM.requestChildNodes', 'params': params}
...
def request_node(
    ...
    params: T_JSON_DICT = {}
    params['objectId'] = object_id.to_json()
    json = yield {'method': 'DOM.requestNode', 'params': params}
    return NodeId.from_json(json['nodeId'])
...
def resolve_node(
    ...
    json = yield {'method': 'DOM.resolveNode', 'params': params}
...
def set_attribute_value(
    ...
    params['name'] = name
    params['value'] = value
    yield {'method': 'DOM.setAttributeValue', 'params': params}
...
def set_attributes_as_text(
    ...
    if name is not None:
        params['name'] = name
    yield {'method': 'DOM.setAttributesAsText', 'params': params}
...
def set_file_input_files(
    ...
    if object_id is not None:
        params['objectId'] = object_id.to_json()
    yield {'method': 'DOM.setFileInputFiles', 'params': params}
...
def set_node_stack_traces_enabled(enable: bool) -> typing.Generator[T_JSON_DICT, T_JSON_DICT, None]:
    ...
    **EXPERIMENTAL**
    ...
    yield {'method': 'DOM.setNodeStackTracesEnabled', 'params': params}
...
def get_node_stack_traces(
    ...
    **EXPERIMENTAL**
    ...
    params: T_JSON_DICT = {}
    params['nodeId'] = node_id.to_json()
    json = yield {'method': 'DOM.getNodeStackTraces', 'params': params}
    return runtime.StackTrace.from_json(json['creation']) if json.get('creation') is not None else None
...
def get_file_info(
    ...
    **EXPERIMENTAL**
    ...
    params: T_JSON_DICT = {}
    params['objectId'] = object_id.to_json()
    json = yield {'method': 'DOM.getFileInfo', 'params': params}
    return json['path']
...
def get_detached_dom_nodes() -> typing.Generator[T_JSON_DICT, T_JSON_DICT, list[DetachedElementInfo]]:
    ...
    **EXPERIMENTAL**
    ...
    '''
    json = yield {'method': 'DOM.getDetachedDomNodes'}
...
def set_inspected_node(node_id: NodeId) -> typing.Generator[T_JSON_DICT, T_JSON_DICT, None]:
    ...
    **EXPERIMENTAL**
    ...
    params: T_JSON_DICT = {}
    params['nodeId'] = node_id.to_json()
    yield {'method': 'DOM.setInspectedNode', 'params': params}
...
def set_node_name(node_id: NodeId, name: str) -> typing.Generator[T_JSON_DICT, T_JSON_DICT, NodeId]:
    ...
    params['nodeId'] = node_id.to_json()
    params['name'] = name
    json = yield {'method': 'DOM.setNodeName', 'params': params}
    return NodeId.from_json(json['nodeId'])
...
def set_node_value(node_id: NodeId, value: str) -> typing.Generator[T_JSON_DICT, T_JSON_DICT, None]:
    ...
    params['nodeId'] = node_id.to_json()
    params['value'] = value
    yield {'method': 'DOM.setNodeValue', 'params': params}
...
def set_outer_html(
    ...
    yield {'method': 'DOM.setOuterHTML', 'params': params}
...
def undo() -> typing.Generator[T_JSON_DICT, T_JSON_DICT, None]:
    ...
    **EXPERIMENTAL**
    '''
    yield {'method': 'DOM.undo'}


def get_frame_owner(
        frame_id: page.FrameId,
) -> typing.Generator[T_JSON_DICT, T_JSON_DICT, tuple[BackendNodeId, NodeId | None]]:
    ...
    **EXPERIMENTAL**
    ...
    json = yield {'method': 'DOM.getFrameOwner', 'params': params}
    return (
        BackendNodeId.from_json(json['backendNodeId']),
        NodeId.from_json(json['nodeId']) if json.get('nodeId') is not None else None,
    )
...
def get_container_for_node(
    ...
    **EXPERIMENTAL**
    ...
    json = yield {'method': 'DOM.getContainerForNode', 'params': params}
    return NodeId.from_json(json['nodeId']) if json.get('nodeId') is not None else None
...
def get_querying_descendants_for_container(
    ...
    **EXPERIMENTAL**
    ...
    params: T_JSON_DICT = {}
    params['nodeId'] = node_id.to_json()
    json = yield {'method': 'DOM.getQueryingDescendantsForContainer', 'params': params}
    return [NodeId.from_json(i) for i in json['nodeIds']]
...
def get_anchor_element(
    ...
    **EXPERIMENTAL**
    ...
    json = yield {'method': 'DOM.getAnchorElement', 'params': params}
    return NodeId.from_json(json['nodeId'])
...
def force_show_popover(
    ...
    **EXPERIMENTAL**
    ...
    json = yield {'method': 'DOM.forceShowPopover', 'params': params}
    return [NodeId.from_json(i) for i in json['nodeIds']]
...
class AdoptedStyleSheetsModified:
    ...
    **EXPERIMENTAL**
    ...
    #: Id of the node that has changed.
    node_id: NodeId
    #: New adoptedStyleSheets array. *(EXPERIMENTAL)*
...
class CharacterDataModified:
    ...
    def from_json(cls, json: T_JSON_DICT) -> CharacterDataModified:
        return cls(
            node_id=NodeId.from_json(json['nodeId']),
            character_data=json['characterData'],
        )
...
class ChildNodeCountUpdated:
    ...
    def from_json(cls, json: T_JSON_DICT) -> ChildNodeCountUpdated:
        return cls(
            node_id=NodeId.from_json(json['nodeId']),
            child_node_count=json['childNodeCount'],
        )
...
class ScrollableFlagUpdated:
    ...
    **EXPERIMENTAL**
    ...
    def from_json(cls, json: T_JSON_DICT) -> ScrollableFlagUpdated:
        return cls(
            node_id=NodeId.from_json(json['nodeId']),
            is_scrollable=json['isScrollable'],
        )
...
class AdRelatedStateUpdated:
    ...
    **EXPERIMENTAL**
    ...
    #: The id of the node.
    node_id: NodeId
    #: *(Optional)* The provenance of the ad related node, if it is ad related.
    ad_provenance: network.AdProvenance | None = None
...
class AffectedByStartingStylesFlagUpdated:
    ...
    **EXPERIMENTAL**
    ...
    def from_json(cls, json: T_JSON_DICT) -> AffectedByStartingStylesFlagUpdated:
        return cls(
            node_id=NodeId.from_json(json['nodeId']),
            affected_by_starting_styles=json['affectedByStartingStyles'],
        )
