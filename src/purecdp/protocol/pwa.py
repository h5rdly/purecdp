# DO NOT EDIT — generated by purecdp._generator from PWA (devtools-protocol 3bd8f01934b5)
'''CDP domain: PWA.
...
class FileHandlerAccept:
    ...
    def to_json(self) -> T_JSON_DICT:
        ...
        json['fileExtensions'] = list(self.file_extensions)
        return json
    ...
    def from_json(cls, json: T_JSON_DICT) -> FileHandlerAccept:
        return cls(
            ...
            file_extensions=list(json['fileExtensions']),
        )
...
def get_os_app_state(
    ...
    json = yield {'method': 'PWA.getOsAppState', 'params': params}
    return (
        json['badgeCount'],
...
def install(
    ...
    yield {'method': 'PWA.install', 'params': params}
...
def uninstall(manifest_id: str) -> typing.Generator[T_JSON_DICT, T_JSON_DICT, None]:
    ...
    params: T_JSON_DICT = {}
    params['manifestId'] = manifest_id
    yield {'method': 'PWA.uninstall', 'params': params}
...
def launch(
    ...
    if url is not None:
        params['url'] = url
    json = yield {'method': 'PWA.launch', 'params': params}
...
def launch_files_in_app(
    ...
    json = yield {'method': 'PWA.launchFilesInApp', 'params': params}
...
def open_current_page_in_app(manifest_id: str) -> typing.Generator[T_JSON_DICT, T_JSON_DICT, None]:
    ...
    params: T_JSON_DICT = {}
    params['manifestId'] = manifest_id
    yield {'method': 'PWA.openCurrentPageInApp', 'params': params}
...
def change_app_user_settings(
    ...
    yield {'method': 'PWA.changeAppUserSettings', 'params': params}
