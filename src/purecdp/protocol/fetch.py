# DO NOT EDIT — generated by purecdp._generator from Fetch (devtools-protocol 3bd8f01934b5)
'''CDP domain: Fetch.
...
class RequestStage(enum.StrEnum):
...
class RequestPattern:
    ...
    def from_json(cls, json: T_JSON_DICT) -> RequestPattern:
        return cls(
            ...
            resource_type=network.ResourceType.from_json(json['resourceType']) if json.get('resourceType') is not None else None,
            request_stage=RequestStage.from_json(json['requestStage']) if json.get('requestStage') is not None else None,
        )
...
def enable(
    ...
    yield {'method': 'Fetch.enable', 'params': params}
...
def fail_request(
    ...
    yield {'method': 'Fetch.failRequest', 'params': params}
...
def fulfill_request(
    ...
    yield {'method': 'Fetch.fulfillRequest', 'params': params}
...
def continue_request(
    ...
    :param intercept_response: *(Optional)* If set, overrides response interception behavior for this request. *(EXPERIMENTAL)*
    '''
    params: T_JSON_DICT = {}
    params['requestId'] = request_id.to_json()
    if url is not None:
    ...
    yield {'method': 'Fetch.continueRequest', 'params': params}
...
def continue_with_auth(
    ...
    yield {'method': 'Fetch.continueWithAuth', 'params': params}
...
def continue_response(
    ...
    **EXPERIMENTAL**
    ...
    if binary_response_headers is not None:
        params['binaryResponseHeaders'] = binary_response_headers
    yield {'method': 'Fetch.continueResponse', 'params': params}
...
def get_response_body(
    ...
    params: T_JSON_DICT = {}
    params['requestId'] = request_id.to_json()
    json = yield {'method': 'Fetch.getResponseBody', 'params': params}
    return (
        json['body'],
        json['base64Encoded'],
    )
...
def take_response_body_as_stream(
    ...
    params: T_JSON_DICT = {}
    params['requestId'] = request_id.to_json()
    json = yield {'method': 'Fetch.takeResponseBodyAsStream', 'params': params}
...
class RequestPaused:
    ...
    #: *(Optional)* Response status text if intercepted at response stage.
    response_status_text: str | None = None
    #: *(Optional)* Response headers if intercepted at the response stage.
    response_headers: list[HeaderEntry] | None = None
    #: *(Optional)* If the intercepted request had a corresponding Network.requestWillBeSent event fired for it, then this networkId will be the same as the requestId present in the requestWillBeSent event.
    network_id: network.RequestId | None = None
    #: *(Optional)* If the request is due to a redirect response from the server, the id of the request that has caused the redirect. *(EXPERIMENTAL)*
    ...
    def from_json(cls, json: T_JSON_DICT) -> RequestPaused:
        return cls(
            ...
            response_error_reason=network.ErrorReason.from_json(json['responseErrorReason']) if json.get('responseErrorReason') is not None else None,
            response_status_code=json['responseStatusCode'] if json.get('responseStatusCode') is not None else None,
            response_status_text=json['responseStatusText'] if json.get('responseStatusText') is not None else None,
            response_headers=[HeaderEntry.from_json(i) for i in json['responseHeaders']] if json.get('responseHeaders') is not None else None,
            network_id=network.RequestId.from_json(json['networkId']) if json.get('networkId') is not None else None,
            redirected_request_id=RequestId.from_json(json['redirectedRequestId']) if json.get('redirectedRequestId') is not None else None,
        )
