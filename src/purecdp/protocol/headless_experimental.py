# DO NOT EDIT — generated by purecdp._generator from HeadlessExperimental (devtools-protocol 3bd8f01934b5)
'''CDP domain: HeadlessExperimental.
...
class ScreenshotParams:
    ...
    #: *(Optional)* Image compression format (defaults to png). Allowed values: jpeg, png, webp
    format: str | None = None
    #: *(Optional)* Compression quality from range [0..100] (jpeg and webp only).
    quality: int | None = None
    #: *(Optional)* Optimize image encoding for speed, not for resulting size (defaults to false)
    ...
    def from_json(cls, json: T_JSON_DICT) -> ScreenshotParams:
        return cls(
            format=json['format'] if json.get('format') is not None else None,
            quality=json['quality'] if json.get('quality') is not None else None,
            optimize_for_speed=json['optimizeForSpeed'] if json.get('optimizeForSpeed') is not None else None,
        )
...
def begin_frame(
    ...
    json = yield {'method': 'HeadlessExperimental.beginFrame', 'params': params}
    return (
        json['hasDamage'],
        json['screenshotData'] if json.get('screenshotData') is not None else None,
    )
...
def disable() -> typing.Generator[T_JSON_DICT, T_JSON_DICT, None]:
    ...
    **DEPRECATED**
    '''
    yield {'method': 'HeadlessExperimental.disable'}
...
def enable() -> typing.Generator[T_JSON_DICT, T_JSON_DICT, None]:
    ...
    **DEPRECATED**
    '''
    yield {'method': 'HeadlessExperimental.enable'}
